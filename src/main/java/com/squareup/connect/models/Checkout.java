...
public class Checkout {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "ID generated by Square Checkout when a new checkout is requested.")
  public String getId() {
    return id;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "The URL that the buyer's browser should be redirected to after the checkout is completed.")
  ...
  **/
   ...
   * @return order
  **/
  @ApiModelProperty(example = "null", value = "Order to be checked out.")
   ...
   * @return createdAt
  **/
  @ApiModelProperty(example = "null", value = "The time when the checkout was created, in RFC 3339 format.")

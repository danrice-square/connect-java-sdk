...
public class CreateCustomerCardRequest {
   ...
   * @return cardNonce
  **/
  @ApiModelProperty(example = "null", required = true, value = "A card nonce representing the credit card to link to the customer.  Card nonces are generated by the `SqPaymentForm` that buyers enter their card information into. See [Embedding the payment form](/articles/adding-payment-form/) for more information.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Address information for the card on file. Only the `postal_code` field is required for payments in the US and Canada.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The cardholder's name.")

...
public class Transaction {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "The transaction's unique ID, issued by Square payments servers.")
  public String getId() {
    return id;
  }
  ...
  **/
   ...
   * @return createdAt
  **/
  @ApiModelProperty(example = "null", value = "The time when the transaction was created, in RFC 3339 format.")
   ...
   * @return tenders
  **/
  @ApiModelProperty(example = "null", value = "The tenders used to pay in the transaction.")
   ...
   * @return refunds
  **/
  @ApiModelProperty(example = "null", value = "Refunds that have been applied to any tender in the transaction.")
   ...
   * @return referenceId
  **/
  @ApiModelProperty(example = "null", value = "If the transaction was created with the [Charge](#endpoint-charge) endpoint, this value is the same as the value provided for the `reference_id` parameter in the request to that endpoint. Otherwise, it is not set.")
   ...
   * @return product
  **/
  @ApiModelProperty(example = "null", value = "The Square product that processed the transaction.")
   ...
   * @return clientId
  **/
  @ApiModelProperty(example = "null", value = "If the transaction was created in the Square Register app, this value is the ID generated for the transaction by Square Register.  This ID has no relationship to the transaction's canonical `id`, which is generated by Square's backend servers. This value is generated for bookkeeping purposes, in case the transaction cannot immediately be completed (for example, if the transaction is processed in offline mode).  It is not currently possible with the Connect API to perform a transaction lookup by this value.")
   ...
   * @return order
  **/
  @ApiModelProperty(example = "null", value = "The order associated with this transaction, if any.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The shipping address provided in the request, if any.")
